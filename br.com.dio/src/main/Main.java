...
public class Main {
	...
	public static void main(String[] args) {		
		...
		while (true) {
			...
			System.out.println("4- Buscar usuário por identificador");
	...
	private UserModel validatorInputs(final long id, final String name, final String email, final LocalDate birthday) {
